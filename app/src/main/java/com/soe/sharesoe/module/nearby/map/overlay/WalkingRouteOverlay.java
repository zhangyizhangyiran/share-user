package com.soe.sharesoe.module.nearby.map.overlay;
            ...
            overlayList.add((new MarkerOptions())
                    ...
                    .icon(getStartMarker() != null ? getStartMarker() :
                            BitmapDescriptorFactory
                                    .fromResource(R.mipmap.icon_location_now)).zIndex(0));
        ...
        if (mRouteLine.getTerminal() != null) {
            overlayList.add((new MarkerOptions())
                    ...
                    .icon(getTerminalMarker() != null ? getTerminalMarker() :
                            BitmapDescriptorFactory
                                    .fromResource(R.mipmap.icon_sort_box))
                    .zIndex(0));
            ...
            for (WalkingRouteLine.WalkingStep step : mRouteLine.getAllStep()) {
                ...
                if (watPoints != null) {
                    ...
                    overlayList.add(new PolylineOptions().points(points).width(10)
                            .color(getLineColor() != 0 ? getLineColor() : Color.parseColor("#FF4A90E2")).zIndex(0));
