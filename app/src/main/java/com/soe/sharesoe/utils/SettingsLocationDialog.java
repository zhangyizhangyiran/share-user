 ...
 */
public class SettingsLocationDialog {

    public static final int DEFAULT_SETTINGS_REQ_CODE = 16061;

    private AlertDialog mAlertDialog;

    private SettingsLocationDialog(@NonNull final Object activityOrFragment,
...
//                intent.setData(uri);
    ...
    /**
     * Builder for an {@link SettingsLocationDialog}.
     */
    public static class Builder {
        ...
        /**
         * Create a new Builder for an {@link SettingsLocationDialog}.
        ...
        /**
         * Build the {@link SettingsLocationDialog} from the specified options. Generally followed by a
         * call to {@link SettingsLocationDialog#show()}.
         */
        public SettingsLocationDialog build() {
            return new SettingsLocationDialog(mActivityOrFragment, mContext, mRationale, mTitle,
