package com.soe.sharesoe.widget.IndexBar.widget;
...
import com.soe.sharesoe.widget.IndexBar.helper.IIndexBarDataHelper;
import com.soe.sharesoe.widget.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(context.getResources().getColor(R.color.Color_Theme_Text_Categ));
